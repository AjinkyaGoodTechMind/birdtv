...
export default function EditPlayer() {
  ...
  const [preRollAd, setPreRollAd] = useState(player.ad_preload);
  const [postRollAd, setPostRollAd] = useState(player.ad_postload);
  ...
  useEffect(() => {
    if (player) {
      ...
      setGeneral(player.generalSettings);
      setSticky(player.sticky);
      setAdUnit(player.adUnit);
      setAds(player.ads);
    }
  }, [player]);
  ...
  const handleSavePlayer = async () => {
    let config = {
      ...
      data: { generalSettings: general, sticky, adUnit, ads, playerName: name, playerId: player._id },
    };
    ...
    <div className="addPlayer">
      ...
      <div className="addPlayer-main">
        ...
        <div className="addPlayer-main-container">
              ...
              <>
                ...
                {adUnit.inSlide && (
                  <div className="addPlayer-inputs" style={{ marginLeft: "60px", width: "100px" }}>
                    <span>Position</span>
                    <select value={adUnit.position} onChange={(e) => setAdUnit((prev) => ({ ...prev, position: e.target.value }))}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ width: `${general.playerSize.width}px`, height: `${general.playerSize.height}px`, maxWidth: "900px", maxHeight: "510px" }}>
              <ReactPlayer
                // playing={autoPlay}
                url={videoSrc}
                width="100%"
